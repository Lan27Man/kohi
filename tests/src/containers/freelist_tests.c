...
u8 freelist_should_allocate_one_and_free_one()
{
    ...
    // Verify that result if true, offset should be set to 0.
...
void freelist_register_tests()
{
    ...
    test_manager_register_test(freelist_should_allocate_one_and_free_one, "Freelist should allocate and free one entry.");
    test_manager_register_test(freelist_should_allocate_one_and_free_multi, "Freelist should allocate and free multiple entries.");
    test_manager_register_test(freelist_should_allocate_one_and_free_multi_varying_sizes, "Freelist should allocate and free multiple entries of varying sizes.");
    test_manager_register_test(freelist_should_allocate_to_full_and_fail_to_allocate_more, "Freelist should allocate to full and fail when trying to allocate more.");
}
