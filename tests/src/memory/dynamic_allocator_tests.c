...
void dynamic_allocator_register_tests()
{
    ...
    test_manager_register_test(dynamic_allocator_single_allocation_all_space, "Dynamic allocator single allocation for all space.");
    test_manager_register_test(dynamic_allocator_multi_allocation_all_space, "Dynamic allocator multi allocation for all space.");
