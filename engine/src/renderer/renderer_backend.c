...
b8 renderer_backend_create(renderer_backend_type type, renderer_backend* out_renderer_backend)
{
    if (type == RENDERER_BACKEND_TYPE_VULKAN)
    {
        ...
        out_renderer_backend->update_global_world_state = vulkan_renderer_backend_update_global_world_state;
        out_renderer_backend->update_global_ui_state = vulkan_renderer_backend_update_global_ui_state;
