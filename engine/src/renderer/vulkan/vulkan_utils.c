...
{
    // From: https://docs.vulkan.org/refpages/latest/refpages/source/VkResult.html
    switch (result)
    {
        // Success Codes
        default:
        ...
        case VK_EVENT_RESET:
            return !get_extended ? "VK_EVEMT_RESET" : "VK_EVENT_RESET An event is unsignaled.";
        case VK_INCOMPLETE:
        ...
        case VK_PIPELINE_COMPILE_REQUIRED_EXT:
            return !get_extended ? "VK_PIPELINE_COMPILE_REQUIRED_EXT" : "VK_PIPELINE_COMPILE_REQUIRED_EXT A requested pipeline creation would have required compilation, but the application requested compilation not to be performed.";
        case VK_PIPELINE_BINARY_MISSING_KHR:
            return !get_extended ? "VK_PIPELINE_BINARY_MISSING_KHR" : "VK_PIPELINE_MISSING_KHR The application attempted to create a pipeline binary by querying an internal cache, but the internal entry did not exist.";
        case VK_INCOMPATIBLE_SHADER_BINARY_EXT:
            return !get_extended ? "VK_INCOMPATIBLE_SHADER_BINARY_EXT" : "VK_INCOMPATIBLE_SHADER_BINARY_EXT The provided binary shader code is not compatible with this device.";
        ...
        case VK_ERROR_INVALID_EXTERNAL_HANDLE:
            return !get_extended ? "VK_ERROR_INVALID_EXTERNAL_HANDLE" : "VK_INVALID_EXTERNAL_HANDLE An external handle is not a valid handle of the specified type.";
        ...
        case VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT:
            return !get_extended ? "VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT" : "VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT A present operation on a swapchain created with VK_SWAPCHAIN_CREATE_PRESENT_TIMING_BIT_EXT failed due to insufficient space in the swapchain's internal results queue to hold requested present timing data.";
        case VK_ERROR_VALIDATION_FAILED:
            return !get_extended ? "VK_ERROR_VALIDATION_FAILED" : "VK_ERROR_VALIDATION_FAILED A command failed because invalid usage was detected by the implementation or a validation layer. This may result in the command not being dispatched to the ICD.";
        case VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
            return !get_extended ? "VK_ERROR_COMPRESSION_EXHAUSTED_EXT" : "VK_ERROR_COMPRESSION_EXHAUSTED_EXT An image creation failed because internal resources required for compression are exhausted. This must only be returned when fixed-rate compression is requested.";
        case VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR" : "VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR The requested VkImageUsage flags are not supported.";
        case VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR" : "VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR The requested video picture layout is not supported.";
        case VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR" : "VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR A video profile operation specified via VkVideoProfileInfoKHR::videoCodecOperation is not supported.";
        case VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR" : "VK_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR Format parameters in a requested VkVideoProfileInfoKHR chain are not supported.";
        case VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR" : "VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR Codec specific parameters in a requested VkVideoProfileInfoKHR chain are not supported.";
        case VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR:
            return !get_extended ? "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR" : "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR The specified video Std header version is not supported.";
        case VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR:
            return !get_extended ? "VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR" : "VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR The specified video Std parameters do not adhere to the syntactic or semantic requirements of the used video compression standard, or values derived from parameters according to the rules defined by the used video compression standard do not adhere to the capabilities of the video compression standard or the implementation.";
        case VK_ERROR_NOT_PERMITTED:
            return !get_extended ? "VK_ERROR_NOT_PERMITTED" : "VK_ERROR_NOT_PERMITTED The driver implementation has denied a request to acquire a priority above the default priority (VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT) because the application does not have sufficient privileges.";
        case VK_ERROR_NOT_ENOUGH_SPACE_KHR:
            return !get_extended ? "VK_ERROR_NOT_ENOUGH_SPACE_KHR" : "VK_ERROR_NOT_ENOUGH_SPACE_KHR The application did not provide enough space to return all the required data.";
