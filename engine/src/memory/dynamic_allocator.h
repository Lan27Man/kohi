 ...
 * @param memory_requirement A pointer to hold the required memory for the internal state *PLUS* total_size.
 ...
 * @returns The allocated block of memory unless this operation fails, then 0.
*/
